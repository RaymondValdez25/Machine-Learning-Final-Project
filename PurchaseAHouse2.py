#Uses 8 different features


#Data contains Z-norm but uses same data as PurchaseAHouse
...
X_features = ["BHK","Size (sq feet)","Area Type","City","Furnishing Status","Tenant Preferred","Number of Bathrooms","Point of contact"]
